...
from data.cifarloader import CIFAR100Loader, StageCIFAR100Loader, PARTITION_CONFIG
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rotnet_dir', type=str, default='./data/experiments/auto_novel_selfsupervised_learning/rotnet.pth')
    ...
    #labeled_train_loader, _ = StageCIFAR100Loader(root=args.dataset_root, batch_size=args.batch_size, split='train', aug='once', shuffle=True, partition_config=PARTITION_CONFIG['stage 1'])
    #labeled_eval_loader, _ = StageCIFAR100Loader(root=args.dataset_root, batch_size=args.batch_size, split='test', aug=None, shuffle=False, partition_config=PARTITION_CONFIG['stage 1'])
